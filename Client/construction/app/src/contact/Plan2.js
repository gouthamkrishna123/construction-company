...
function Pla() {
  ...
  const validate = () => {
    ...
    if (!values.choose) errors.choose = 'Selection is required';
    if (!/^\d{1,10}$/.test(values.squre)) errors.squre = 'Square feet is required';
    ...
    if (Object.keys(validationErrors).length === 0) {
      axios.post('http://localhost:8000/appo', values)
        .then(response => {
          ...
          alert('Thank you for your response. Our team will contact you.');
          navigate('/');
        })
      ...
      <div>
        <div>
          <div style={{ backgroundColor: "black" }}>
            <img style={{ width: "100%", height: "350px", opacity: ".3" }} src={contact1} alt="Contact Us" />
          </div>
        ...
        <div className="card-mb-3">
          <div className="row g-0" style={{ boxShadow: "1px 5px 30px 30px lightgray" }}>
            <div style={{ boxShadow: "5px 10px 30px 30px lightgray" }} className="col-md-6">
              ...
              <div style={{ textAlign: "center", marginLeft: "50px", width: "80%", height: "700px", border: "solid 4px", color: "red" }}>
                <Link to="project">
              ...
              <div style={{ position: "relative", textAlign: "center" }}>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-3 mt-3">
                    <input
                      type="text"
                      style={{ width: "80%", border: "1px solid grey", height: "40px", boxSizing: "content-box", marginLeft: '20px' }}
                      ...
                      <div className="row g-0">
                        <div className="col-md-6">
                          <div style={{ textAlign: "left", marginLeft: "40px" }}>
                            <input
                              ...
                              name="choose"
                              value="Site Plan"
                              checked={values.choose === 'Site Plan'}
                              onChange={handleChange}
                              required
                            />
                            <label htmlFor="Site Plan">Site Plan</label>
                            <br />
                            <input
                              type="radio"
                              id="Interiors Design"
                              name="choose"
                              value="Interiors Design"
                              checked={values.choose === 'Interiors Design'}
                              onChange={handleChange}
                              required
                            />
                            <label htmlFor="Interiors Design">Interiors Design</label>
                            <br />
                            <input
                              type="radio"
                              id="Renovation"
                              name="choose"
                              value="Renovation"
                              checked={values.choose === 'Renovation'}
                              onChange={handleChange}
                              required
                            />
                        ...
                        <div className="col-md-6">
                          <div>
                            <input
                              type="tel"
                              style={{ width: "60%", border: "1px solid grey", height: "40px", boxSizing: "content-box", marginLeft: '10px' }}
                              className="form-control"
                              id="squre"
                              placeholder="sq.ft"
                              name="squre"
                              ...
                              required
                            />
                            {errors.squre && <div className="invalid-feedback">{errors.squre}</div>}
                          </div>
                        </div>
                      </div>
                    </div>
                    <br />
                    <textarea
                      style={{ width: "80%", border: "1px solid grey", height: "200px", boxSizing: "content-box", marginLeft: '20px' }}
                      className="form-control"
                      id="message"
                      placeholder="About your Construction"
                      name="message"
                    ...
                    <br /><br /><br />
                    <div className="container">
                      <Button style={{ width: "200px", height: "50px", backgroundColor: "red" }} type="submit"><b>Get Appointment</b></Button>
                    </div>
                  </div>
                </form>
              </div>
